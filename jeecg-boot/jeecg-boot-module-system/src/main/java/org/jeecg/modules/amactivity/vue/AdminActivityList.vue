<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('admin activity')">导出</a-button>
    ...
    <admin-activity-modal ref="modalForm" @ok="modalFormOk"></admin-activity-modal>
  </a-card>
</template>
...
<script>
  ...
  import AdminActivityModal from './modules/AdminActivityModal'
  ...
  export default {
    ...
    data () {
      return {
        description: 'admin activity管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          ...
          delete: "/amactivity/adminActivity/delete",
          deleteBatch: "/amactivity/adminActivity/deleteBatch",
          exportXlsUrl: "/amactivity/adminActivity/exportXls",
          importExcelUrl: "amactivity/adminActivity/importExcel",
