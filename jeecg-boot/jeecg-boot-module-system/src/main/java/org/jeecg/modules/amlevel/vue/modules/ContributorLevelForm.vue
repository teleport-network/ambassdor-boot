    ...
    data () {
      return {
        ...
        validatorRules: {
           name: [
              { required: false},
              { validator: (rule, value, callback) => validateDuplicateValue('contributor_level', 'name', value, this.model.id, callback)},
           ],
        },
        url: {
          add: "/amlevel/contributorLevel/add",
          edit: "/amlevel/contributorLevel/edit",
          queryById: "/amlevel/contributorLevel/queryById"
        }
      }
    },
    computed: {
