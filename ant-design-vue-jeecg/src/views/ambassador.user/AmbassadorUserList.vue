<template>
  <a-card :bordered="false">
    ...
    <ambassador-user-modal ref="modalForm" @ok="modalFormOk"></ambassador-user-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/ambassador.user/ambassadorUser/list",
          delete: "/ambassador.user/ambassadorUser/delete",
          deleteBatch: "/ambassador.user/ambassadorUser/deleteBatch",
          exportXlsUrl: "/ambassador.user/ambassadorUser/exportXls",
          importExcelUrl: "ambassador.user/ambassadorUser/importExcel",
